...
public class CarroApiConstants {
    ...
    public static final String UPDATE_CAR = "/car/{regNumber}";
    ...
    public static final String GET_CAR_BOOKINGS = "/user/cars/periods/{regNumber}"; // !
    public static final String BOOK_CAR = "/car/reservation/{regNumber}";
    ...
    public static final String FIND_BY = "/search";  // "/search/city/{start date}/{end date}"
